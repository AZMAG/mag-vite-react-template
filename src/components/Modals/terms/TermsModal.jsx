...
export default function Terms() {
  ...
  return (
    <>
      <a type="button" rel="noreferrer" onClick={setShowModal}>
        Terms
      </a>
      {showModal ? (
        <>
          <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden outline-none focus:outline-none">
            <div className="relative my-6 mx-auto w-auto max-w-3xl">
              ...
              <div className="relative flex w-full flex-col rounded-lg border-0 bg-white shadow-lg outline-none focus:outline-none">
                {/*header*/}
                <div className="flex items-center gap-x-2 rounded-t border-b border-solid border-slate-400 bg-slate-100 p-4">
                  <FaUserEdit className="text-3xl text-magTeal" />
                  <h3 className="text-3xl font-semibold">Terms</h3>
                  <button
